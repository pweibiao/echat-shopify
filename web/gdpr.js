...
// const url = 'https://middle-node.echatsoft.com'
const url = 'http://127.0.0.1:3000'
const path1 = url + '/shopify/getShopifyUser'
const path2 = url + '/shopify/removeShopifyUser'
const path3 = url + '/shopify/removeShopifyShop'
